...
export default function SupportDashboard({ view = 'overview' }: SupportDashboardProps) {
  ...
  const filteredTechnicians = technicians.filter((t) => t.teamLeadId === selectedTeamLeadId);
...
//   const showStats = view === 'overview' || view === 'analytics';
//   const showQueue = view === 'overview' || view === 'queue';
//   const showAnalytics = view === 'analytics';

//   const pageTitle =
//     view === 'queue' ? 'Support Queue' : view === 'analytics' ? 'Support Analytics' : 'Support Dashboard';
