...
export default function TicketDetailModal({
  ...
  const getStatusColor = (status: number): string => {
    switch (status) {
      ...
      case 5:
        return 'bg-gray-100 text-gray-800 border-gray-300 dark:bg-slate-800 dark:text-gray-300 dark:border-slate-600';
      default:
        return 'bg-gray-100 text-gray-800 border-gray-300 dark:bg-slate-800 dark:text-gray-300 dark:border-slate-600';
    }
  };
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl max-w-xl w-full my-8 max-h-[90vh] flex flex-col overflow-hidden border border-gray-100 dark:border-slate-800 transform transition-all">
              ...
              <div className="space-y-6">
                ...
                <div className="pb-4">
                  ...
                  <div className="flex gap-4 border-b border-gray-100 dark:border-slate-800 pb-5">
                    <div>
                      <p className="text-[10px] text-gray-400 dark:text-gray-500 font-semibold mb-1.5 uppercase tracking-wider">
                        Status
                      </p>
                      <span
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium border ${getPriorityColor(
                          ticket.priority
                        )}`}
                      >
                ...
                {/* Category */}
                <div>
                  <p className="text-[10px] text-gray-400 dark:text-gray-500 font-semibold mb-2 uppercase tracking-wider">
                    Category
                  </p>
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                  <div>
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 font-semibold mb-1 uppercase tracking-wider">
                      Created On
                    </p>
          ...
          {/* Footer */}
          <div className="flex-none px-6 py-4 flex justify-end gap-3 border-t border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-900/50 z-10">
            <button
              onClick={onClose}
              className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            >
              Close
            </button>
